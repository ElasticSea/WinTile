...
public static class WindowList
{
    ...
    public static List<WindowInformation> GetAllWindows()
    {
        ...
        var winInfo = new List<WindowInformation>();
    ...
    public static void PosCurrentwIND()
    {
        var handle = GetForegroundWindow();
    ...
    {
        var winInfoList = new List<WindowInformation>();
    ...
    private static WindowInformation winInfoGet(IntPtr hWnd)
    {
        ...
        else
        {
            caption =
                new StringBuilder(
                    Convert.ToInt32(SendMessage(wi.Handle, WMConstants.WM_GETTEXTLENGTH, IntPtr.Zero, IntPtr.Zero)) + 1);
